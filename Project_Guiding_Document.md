...
**Our guiding philosophy is "Less is More":** Network files should be sparse, primarily containing `!provider:<slug>` references. Data is added only if verified and provides genuine new value. Empty cells is intentional, signaling "Inherit" or "No Data."
